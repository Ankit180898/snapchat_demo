...
import 'package:snapchat_demo/config.dart';
...
class _MyAppState extends State<MyApp> {
  ...
  final  CameraDeepArController _controller = CameraDeepArController(config.newConfig);
  String _platformVersion = 'Unknown';
  bool isRecording = false;
  CameraMode cameraMode = config.newConfig.cameraMode;
  DisplayMode displayMode = config.newConfig.displayMode;
  int currentEffect = 0;
                            ...
                            Expanded(
                              child: MaterialButton(
                                onPressed: () async {
                                  ...
                                  _controller.changeImage(file.path);
                        ...
                        return Expanded(
                          child: Container(
                            ...
                            child: TextButton(
                              onPressed: () async {
                                displayMode = mode;
                                await _controller.setDisplayMode(
                                    mode: mode);
                                setState(() {});
                              },
                              style: TextButton.styleFrom(
